...
let rowtmpl = '<tr class="row">'
            ...
            + '  <td class="col-2 jobtype">{{jobtype}}</td>'
...
let btnactionstmpl = '<!--<button type="button" class="btn btn-outline-dark btn-sm" data-toggle="tooltip" data-placement="bottom" title="Fetch status"><i class="fas fa-sync-alt fa-fw"></i></button>\n-->'
                   + '<button type="button" class="btn btn-outline-dark btn-sm" data-toggle="tooltip" data-placement="bottom" title="Open job"><i class="fas fa-external-link-alt fa-fw"></i></button>\n'
                   ...
                   + '<button type="button" class="btn btn-outline-success btn-sm" data-toggle="tooltip" data-placement="bottom" title="Show detailed info"><i class="fas fa-info fa-fw"></i></button>\n'
